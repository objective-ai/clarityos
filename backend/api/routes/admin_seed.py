...
async def seed_demo(
    ...
    db.add(ExamFindings(
        ...
        findings_od={
            "lids": "Normal",
            "conjunctiva": "Clear",
            "cornea": "Punctate staining inferiorly",
            "lens": "Grade 1 nuclear sclerosis",
        },
        findings_os={
            "lids": "Normal",
            "conjunctiva": "Clear",
    ...
    db.add(ExamFindings(
        ...
        is_normal_wnl=True,
        findings_od={
            "disc": "0.35 CDR, sharp margins, healthy rim tissue",
            "macula": "Flat, no drusen",
            "vessels": "Normal A/V ratio",
            "periphery": "Flat, no breaks or detachment",
        },
        findings_os={
            "disc": "0.35 CDR, sharp margins, healthy rim tissue",
            "macula": "Flat, no exudates",
            "vessels": "Normal A/V ratio",
            "periphery": "Flat, no breaks or detachment",
        },
