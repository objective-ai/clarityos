        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="px-7 pb-6 flex flex-col gap-3">
            ...
            {linkResults.length > 0 && (
              <ul className="divide-y divide-[var(--border-subtle)] border border-[var(--border-default)] rounded-lg overflow-hidden">
            ...
            {linkResults.length === 0 && linkEmail && !linkSearching && (
              <p className="text-xs text-[var(--text-muted)] text-center">No results. Try a different email.</p>
            )}
          </div>
        </DialogContent>
      </Dialog>
