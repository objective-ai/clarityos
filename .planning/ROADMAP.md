...
Plans:
- [ ] 01-01: Security hardening (remove dev bypass, hardcoded secrets, mock session seed, add security headers)
- [ ] 01-02: Supabase Auth integration (login page, middleware, sessionStore, JWT claims, inactivity timeout)
- [ ] 01-03: Backend infrastructure (relocate Python to backend/, Alembic setup, BFF route handlers)
...
|-------|----------------|--------|-----------|
| 1. Security & Auth Foundation | 0/3 | Not started | - |
